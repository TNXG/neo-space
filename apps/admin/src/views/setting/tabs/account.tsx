...
const useActivePanel = () => {
  ...
  if (!ctx)
    throw new Error("useActivePanel must be used within TabAccount");
  return ctx;
};
...
const SessionSection = defineComponent(() => {
  ...
  const SessionItem = ({
    ...
    <div class="px-4 py-4">
      ...
      {ua && (
        <div class="text-xs text-neutral-600 font-mono mb-2 dark:text-neutral-300">
          {ua}
        </div>
      )}

      <div class="text-xs text-neutral-500 flex flex-wrap gap-4 items-center dark:text-neutral-400">
        {ip && (
            ...
            <div class="divide-neutral-100 divide-y dark:divide-neutral-800">
              ...
              {hasMore.value && (
                <div class="px-4 py-3">
                  <button
                    type="button"
                    class="text-sm text-neutral-500 flex gap-1.5 w-full transition-colors items-center justify-center dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200"
                    onClick={() => {
    ...
    >
      ...
      >
        <div>
          ...
          <div class="text-xs text-neutral-500 mt-0.5 dark:text-neutral-400">
            {isLoading.value
              ? "加载中..."
      ...
      <div class="group px-4 py-4">
        <div class="mb-2 flex items-center justify-between">
          <div class="flex gap-2 items-center">
            <KeyIcon class="text-neutral-400 size-4" />
        ...
        <div class="mb-2">
          {isVisible && token && token !== "*".repeat(40)
            ? (
                <button
                  type="button"
                  class="text-xs text-blue-600 font-mono max-w-full truncate dark:text-blue-400 hover:underline"
  ...
  return () => (
    <>
      <div class="flex flex-col h-full">
        <div class="px-4 border-b border-neutral-200 flex shrink-0 h-14 items-center justify-between dark:border-neutral-800">
            ...
            : !tokens.value?.length
                ? (
                    <div class="py-16 text-center flex flex-col items-center justify-center">
                      ...
                      <h3 class="text-sm text-neutral-900 font-medium m-0 mb-1 dark:text-neutral-100">
                        暂无 Token
                      </h3>
                      <p class="text-xs text-neutral-500 m-0 dark:text-neutral-400">
      ...
      >
        ...
        >
          <div class="space-y-4">
            <div class="text-green-700 px-4 py-3 rounded-lg bg-green-50 flex gap-2 items-center dark:text-green-400 dark:bg-green-900/20">
              <CheckIcon class="size-5" />
              <span>Token 创建成功，请妥善保存</span>
            </div>
            <div class="space-y-3">
              <div class="text-sm px-4 py-3 rounded-lg bg-neutral-50 flex gap-2 items-center dark:bg-neutral-800">
                <span class="text-neutral-500 shrink-0 dark:text-neutral-400">
                  Token 名称:
                </span>
                <span class="text-neutral-700 font-medium ml-auto dark:text-neutral-200">
              ...
              <div>
                ...
                <div class="p-3 border border-neutral-200 rounded-lg bg-neutral-50 flex gap-2 items-center dark:border-neutral-700 dark:bg-neutral-800">
                  <NText code class="text-sm flex-1 break-all">
            ...
            <div class="text-sm text-amber-700 px-4 py-3 rounded-lg bg-amber-50 dark:text-amber-400 dark:bg-amber-900/20">
  ...
  const PasskeyItem = ({
    ...
    <div class="group px-4 py-4">
      <div class="flex items-center justify-between">
        <div class="flex gap-2 items-center">
          <FingerprintIcon class="text-blue-500 size-4" />
          <span class="text-neutral-900 font-medium dark:text-neutral-100">
            {passkey.name}
          </span>
        </div>
