...
export const TabMetaPresets = defineComponent({
  ...
  setup() {
    ...
    const handleDrop = (e: DragEvent, dropIndex: number) => {
      e.preventDefault();
      if (draggedIndex.value === null || !presets.value)
        return;
  ...
  setup(props) {
    return () => (
      <div class="py-12 text-center flex flex-col items-center justify-center">
        <div class="mb-4 rounded-full bg-neutral-100 flex size-14 items-center justify-center dark:bg-neutral-800">
          <ListPlusIcon class="text-neutral-400 size-7" aria-hidden="true" />
        </div>
        <h3 class="text-sm text-neutral-900 font-medium mb-1 dark:text-neutral-100">
          暂无预设字段
        </h3>
        <p class="text-xs text-neutral-500 mb-4 dark:text-neutral-400">
    ...
    return () => (
      <div class="animate-pulse">
        {[1, 2, 3].map(i => (
          <div
            key={i}
            class="py-3 border-b border-neutral-100 flex gap-4 items-center last:border-b-0 dark:border-neutral-800"
          >
            <div class="rounded bg-neutral-200 size-5 dark:bg-neutral-700" />
            <div class="flex-1">
              <div class="rounded bg-neutral-200 h-4 w-32 dark:bg-neutral-700" />
              <div class="mt-2 rounded bg-neutral-100 h-3 w-48 dark:bg-neutral-800" />
            </div>
            <div class="flex gap-2">
              <div class="rounded bg-neutral-100 h-6 w-14 dark:bg-neutral-800" />
              <div class="rounded bg-neutral-100 h-6 w-14 dark:bg-neutral-800" />
            </div>
          </div>
        ))}
