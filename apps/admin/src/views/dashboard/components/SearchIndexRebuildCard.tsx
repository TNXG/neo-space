      ...
      <div class="p-3 rounded-md">
        <div class="flex gap-2 items-start justify-between">
          <div class="flex-1 min-w-0">
            ...
            <div class="text-xl font-semibold mt-1 tabular-nums">BM25</div>
            <p class="text-xs text-neutral-400 mt-1 line-clamp-2 dark:text-neutral-500">
        ...
        <div class="mt-3 flex flex-wrap gap-2 items-center">
          ...
          >
            {{
              ...
              default: () => (
                <div class="text-xs leading-relaxed max-w-[20rem]">
