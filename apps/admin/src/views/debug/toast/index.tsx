...
export default defineComponent({
  setup() {
    return () => (
      <div class="mx-auto p-6 max-w-4xl space-y-6">
        <h1 class="text-2xl text-neutral-900 font-semibold dark:text-neutral-100">
          Toast 测试
        </h1>
        ...
        <NCard title="基础用法" class="!rounded-xl">
          <div class="space-y-4">
            <div>
              <h4 class="text-sm text-neutral-700 font-medium mb-2 dark:text-neutral-300">
                状态类型
              </h4>
              <NSpace>
        ...
        <NCard title="带 Action 按钮" class="!rounded-xl">
          <div class="space-y-4">
            ...
            <div>
              ...
              <p class="text-xs text-neutral-400 mb-2">检测到新版本提醒</p>
              <NSpace>
                <NButton
                  onClick={() => {
            ...
            <div>
              ...
              <p class="text-xs text-neutral-400 mb-2">删除后提供撤销功能</p>
              <NSpace>
                <NButton
                  onClick={() => {
                    toast.success("文件已删除", {
