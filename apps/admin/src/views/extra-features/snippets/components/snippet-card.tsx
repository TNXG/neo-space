        ...
        return (
          ...
          >
            {(() => {
              ...
              return (
                <Icon class={`flex-shrink-0 size-3 ${typeIconColor.value}`} />
              );
            })()}
            ...
            {snippet.private && (
              <LockIcon class="text-neutral-400 flex-shrink-0 size-3" />
            )}
            ...
            >
              {{
                trigger: () => (
                  <button
                    class="text-red-500 p-0.5 rounded opacity-0 transition-opacity hover:bg-red-100 group-hover:opacity-100 dark:hover:bg-red-900/50"
        ...
        >
          <div class="flex gap-1.5 items-center">
            {(() => {
              const Icon = typeIcon.value;
              return (
                <Icon class={`flex-shrink-0 size-3.5 ${typeIconColor.value}`} />
              );
            })()}
          ...
          <div class="text-xs text-neutral-500 mt-1 flex gap-2 items-center dark:text-neutral-400">
            <span class="px-1.5 py-0.5 rounded bg-neutral-100 dark:bg-neutral-700">
          ...
          {snippet.comment && (
            <div class="text-xs text-neutral-400 mt-1 truncate dark:text-neutral-500">
              {snippet.comment}
            </div>
          )}
          ...
          >
            <button
              class="p-1 rounded hover:bg-neutral-200 dark:hover:bg-neutral-700"
              onClick={handleExternalLink}
              title="在新窗口打开"
            >
              <ExternalLinkIcon class="text-neutral-500 size-3.5" />
            </button>
            ...
            >
              {{
                trigger: () => (
                  <button
                    class="text-red-500 p-1 rounded hover:bg-red-100 dark:hover:bg-red-900/50"
                    onClick={(e: MouseEvent) => e.stopPropagation()}
                    title={deleteText}
                  >
