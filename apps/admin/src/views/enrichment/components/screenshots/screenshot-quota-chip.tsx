...
export const ScreenshotQuotaChip = defineComponent({
  ...
  setup(props) {
    ...
    return () => {
      ...
      if (!s) {
        return (
          <span class="text-[11px] text-neutral-400 px-2 py-0.5 border border-neutral-200 rounded-md bg-neutral-50 inline-flex gap-1 items-center dark:border-neutral-800 dark:bg-neutral-900">
            配额加载中…
          </span>
        );
      }
