        ...
        {detectedUrls.value.length > 0 && (
          <div class="space-y-2">
            {detectedUrls.value.map((url) => {
              ...
              return (
                <div key={url}>
                  <div class="text-xs text-neutral-500 mb-1.5 flex gap-2 items-center dark:text-neutral-400">
                    <span>检测到链接：</span>
                    <code class="text-[11px] font-mono px-1.5 py-0.5 rounded bg-neutral-100 truncate dark:bg-neutral-800">
                      {url}
                    </code>
                    {state?.loading && (
                      <LoaderIcon
                  ...
                  {state?.error && !state.loading && (
                    <div class="text-xs text-neutral-500 px-3 py-2 border border-neutral-200 rounded-lg bg-neutral-50 dark:text-neutral-400 dark:border-neutral-800 dark:bg-neutral-900">
