...
export const SplitPanelEmptyState = defineComponent({
  ...
  setup(props) {
    return () => (
      <div class="text-center bg-neutral-50 flex flex-col h-full items-center justify-center dark:bg-neutral-900">
        <div class="mb-4 rounded-full bg-neutral-100 flex size-12 items-center justify-center dark:bg-neutral-800">
          {props.icon()}
        </div>
