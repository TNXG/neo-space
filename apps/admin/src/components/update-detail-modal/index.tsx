      ...
      >
        <NSpin show={loading.value}>
          {releaseDetails.value
                ...
                <div class="space-y-4">
                    ...
                    <div>
                      ...
                      <div class="flex gap-2 items-center">
                        ...
                        <span class="text-sm text-neutral-500">
                          发布于
                          {" "}
                          {formatDate(releaseDetails.value.published_at)}
                        </span>
                      </div>
                    </div>
                  ...
                  {releaseDetails.value.body && (
                    <div class="mt-4">
                      ...
                      <div
                        class="markdown-content leading-relaxed p-4 rounded-lg bg-neutral-50 max-w-none prose prose-sm dark:bg-neutral-800"
            ...
            : !loading.value
                ? (
                    <div class="text-neutral-500 py-8 text-center">
                      无法获取更新详情
                    </div>
                  )
                : null}
