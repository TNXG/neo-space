  ...
  setup(props) {
    ...
    return () => (
      <div class="flex flex-col w-full">
        ...
        {/* WebGL 选项 */}
        <label class="text-xs text-neutral-400 mt-3 flex gap-2 cursor-pointer items-center">
          <NCheckbox
            size="small"
          ...
          <div class="mt-4 space-y-2">
            {images.value.map((image: ImageModel, index: number) => {
              ...
              return (
                <div
                  key={image.src}
                  class="border border-neutral-200 rounded-lg overflow-hidden dark:border-neutral-700"
                >
                  {/* 折叠头部 */}
                  <button
                    type="button"
                    class="px-3 py-2.5 text-left bg-neutral-50 flex gap-2 w-full transition-colors items-center justify-between dark:bg-neutral-800/50 hover:bg-neutral-100 dark:hover:bg-neutral-800"
                    onClick={() => {
                  ...
                  >
                    <span class="text-sm text-neutral-700 flex-1 min-w-0 truncate dark:text-neutral-200">
                      {fileName}
                    </span>
                  ...
                  {isExpanded && (
                    <div
                      ...
                      class="p-3 border-t border-neutral-200 space-y-3 dark:border-neutral-700"
                    >
                      {/* 尺寸 */}
        ...
        {/* 空状态 */}
        {images.value.length === 0 && (
          <div class="text-sm text-neutral-400 mt-4 py-6 text-center border border-neutral-200 rounded-lg border-dashed dark:border-neutral-700">
            文章中暂无图片
          </div>
        )}
      </div>
