  ...
  setup(props) {
    ...
    return () => (
      <div class="space-y-3">
        <button
          type="button"
          class="px-3 py-2.5 text-left border border-neutral-200 rounded-lg flex w-full transition-colors items-center justify-between dark:border-neutral-700 hover:bg-neutral-50 dark:hover:bg-neutral-800/50"
        ...
        {expanded.value && (
          <div class="p-3 border border-neutral-200 rounded-lg dark:border-neutral-700">
            {loading.value
              ? (
                  <div class="space-y-3">
                      ...
                      <NTabPane name="preset" tab="预设字段">
                        <div class="mt-4 p-2 space-y-4">
                          {presets.value.length === 0
                            ? (
                                <div class="text-sm text-neutral-400 py-4 text-center">
                                  暂无可用的预设字段
                                </div>
                              )
                            : (
                          ...
                          {props.meta && Object.keys(props.meta).length > 0 && (
                            <NCollapse accordion>
                              <NCollapseItem title="预览 JSON">
                                <JSONHighlight
                                  class="text-xs p-3 rounded-lg bg-neutral-50 max-w-full overflow-auto dark:bg-neutral-800/50"
