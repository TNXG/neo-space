        ...
        >
          {isOpen.value && position.value && (
            ...
            >
              ...
              >
                <span class="text-xs text-neutral-400 tracking-wider font-medium uppercase dark:text-neutral-500">
                  命令
                </span>
                {query.value && (
                  <span class="text-xs text-neutral-600 font-medium px-1.5 py-0.5 rounded bg-neutral-100 dark:text-neutral-300 dark:bg-neutral-800">
                    /
                    {query.value}
                  </span>
                )}
              ...
              {/* Content */}
              <div class="p-1.5 overscroll-contain flex-1 overflow-y-auto">
                ...
                {groupedItems.value.map((group, groupIndex) => (
                  <div
                    ...
                    key={group.id}
                  >
                    <div class="text-xs text-neutral-400 font-medium px-2 py-1.5 dark:text-neutral-500">
                      {group.label}
                    </div>
                      ...
                      {group.items.map((item) => {
                        ...
                        return (
                          ...
                          >
                            {/* Active indicator */}
                            {isActive && (
                              <div class="rounded-full bg-primary h-5 w-0.5 left-0 top-1/2 absolute -translate-y-1/2" />
                            )}
                            ...
                            <div class="flex-1 min-w-0">
                              ...
                              {item.description && (
                                <div class="text-xs text-neutral-400 truncate dark:text-neutral-500">
                                  {item.description}
                                </div>
                              )}
                            </div>
              ...
              >
                <span class="flex gap-1 items-center">
                  <kbd class="text-xs font-mono px-1 py-0.5 rounded bg-neutral-100 dark:bg-neutral-800">
                    ↑↓
                  </kbd>
                  <span>导航</span>
                </span>
