...
export const StatusToggle = defineComponent<StatusToggleProps>({
  ...
  setup(props) {
    ...
    return () => {
      ...
      return (
        <div
          class={`group rounded inline-flex gap-0.5 transition-all duration-200 items-center justify-center relative ${
        ...
        >
          {/* 默认状态显示 */}
          <div class="flex gap-0.5 transition-opacity duration-200 items-center group-hover:opacity-0">
          ...
          {/* hover时的切换提示 */}
          <div
            class={`rounded bg-inherit opacity-0 flex transition-opacity duration-200 items-center inset-0 justify-center absolute group-hover:opacity-100 ${
