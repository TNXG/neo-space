...
export function CodeBlock({ children, className, language = "text", filename, style, fallbackText }: CodeBlockProps) {
  ...
  return (
    <div className="group relative my-5 md:my-6 overflow-hidden rounded-xl border border-border bg-white/50 shadow-sm transition-all hover:shadow-md backdrop-blur-sm">
      <div className="flex h-10 md:h-11 items-center justify-between border-b border-border/60 bg-zinc-50/50 px-3 md:px-4">
