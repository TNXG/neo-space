...
const bannerStyles = {
	info: {
		container: "bg-blue-50/80 border-blue-200 dark:border-blue-800",
		icon: "text-blue-600 dark:text-blue-400",
		iconPath: "M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z",
	},
	success: {
		container: "bg-green-50/80 border-green-200 dark:border-green-800",
		icon: "text-green-600 dark:text-green-400",
		iconPath: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z",
	},
	warn: {
		container: "bg-yellow-50/80 border-yellow-200 dark:border-yellow-800",
		icon: "text-yellow-600 dark:text-yellow-400",
		iconPath: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z",
	},
	error: {
		container: "bg-red-50/80 border-red-200 dark:border-red-800",
