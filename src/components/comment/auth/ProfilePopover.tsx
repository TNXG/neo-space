	...
	return isOpen
		? (
				<motion.div
					...
					className="absolute bottom-full right-0 mb-3 z-50 w-[280px] sm:w-[320px] bg-popover/95 backdrop-blur-xl border border-border/60 rounded-xl shadow-glass overflow-hidden"
				>
					{/* 用户信息头部 */}
